...
#TOPSAMPDIR=/scratch2/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/expRuns/exp_UFS-Aerosols/AeroDA-1C192-20C192-201710/AERONET/AODTYPE
TOPSAMPDIR=${CURDIR}/AERONET/${AODTYPE}
PLOTTMPDIR=${CURDIR}/AERONET/PLOTS
DAEXP=AeroDA-1C192-20C192-201710 
NODAEXP=FreeRun-1C192-0C192-201710
DASAMPDIR=${TOMSAMPDIR}/${DAEXP}/
NODASAMPDIR=${TOMSAMPDIR}/${NODAEXP}/
EXPS="${NODAEXP} ${DAEXP}"
...
for EXP in ${EXPS}; do
    ...
    for FIELD in ${FIELDS}; do
        ...
        while [ ${CDATE} -le ${EDATE} ]; do
            ...
            OUTDIR=${TOPSAMPDIR}/${EXP}/${FIELD}/${CY}/${CY}${CM}/${CY}${CM}${CD}/
